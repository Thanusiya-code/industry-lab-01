...
public class TestSimpleMaths {
    ...
    @Test
    public void testSphereVolumeInInteger() throws IOException {

        assertEquals(0, cr.getSphereVolumeInInteger(0));

        assertEquals(91, cr.getSphereVolumeInInteger(2.8));

        assertEquals(735618, cr.getSphereVolumeInInteger(56));
    }

    @Test
    public void testRoundedSphereVolume() throws IOException {

        assertEquals(4.19, cr.getRoundedSphereVolume(1.0), DELTA);

        assertEquals(91.95, cr.getRoundedSphereVolume(2.8), DELTA);

        assertEquals(735618.58, cr.getRoundedSphereVolume(56), DELTA);
    }
